...
test("engineering report leads with status and preserves calculations and limitations", () => {
  ...
  assert.match(report, /Result: all fixtures pass \(31\/31\)/);
  ...
  assert.match(report, /rocketworks-stage-interface-loads-0.7.0/);
  assert.match(report, /Separate connector direct-shear review/);
  assert.match(report, /Separate connector eccentricity review/);
