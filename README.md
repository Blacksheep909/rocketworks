...
- component-aware 2D geometry and an interactive 3D vehicle view with clickable
  surface-to-inspector selection plus enabled serial and radial stage previews;
...
- bounded retained-body separation delta-v controls with event-label
  provenance and explicit discarded-body limitations;
