...
- declared aerodynamic-table absolute uncertainty can use independent drag,
  ...
  with optional project or source-declared Gaussian-copula dependence pairs,
  positive-definite matrix checks, and an explicit common-sigma fallback for
  direct force/moment and damping cells;
...
- seeded coupled 6DOF uncertainty envelopes that propagate bounded mass,
  ...
  factors plus table-declared correlation metadata and an explicit
  measured-covariance boundary;
