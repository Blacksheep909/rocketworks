                  ...
                  <div className="topology-stage-body">
                    ...
                    <div className="topology-stage-fields">
                      ...
                      <details className="topology-connector-editor">
                        ...
                        <p>Optional upstream fastener-group evidence for the stage interface. The analytical screen uses direct single-shear area only; bearing, pull-through, preload, prying, fatigue, eccentric group effects, and joint qualification remain outside scope.</p>
