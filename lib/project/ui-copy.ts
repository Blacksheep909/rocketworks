...
const ENGLISH_COPY: UiCopy = {
  ...
  exportDestinationDescription: "RocketWorks asks where to save each export by default. Choose browser Downloads for one-click exports; unsupported browsers fall back to their normal download behavior. This stays separate from engineering data.",
...
const SPANISH_COPY: UiCopy = {
  ...
  exportDestinationDescription: "RocketWorks pregunta dónde guardar cada exportación de forma predeterminada. Elige Descargas del navegador para exportaciones con un clic; los navegadores no compatibles usan su comportamiento normal. Esto permanece separado de los datos de ingeniería.",
