...
const ENGLISH_COPY: UiCopy = {
  ...
  exportDestinationDescription: "Choose Ask where to save to keep exports out of Downloads unless you select a folder. The automatic browser option sends every export to the browser's configured Downloads folder. Unsupported browsers may still use their normal download behavior.",
...
const SPANISH_COPY: UiCopy = {
  ...
  exportDestinationDescription: "Elige Preguntar dónde guardar para mantener las exportaciones fuera de Descargas hasta seleccionar una carpeta. La opción automática del navegador envía cada exportación a su carpeta Descargas configurada. Los navegadores no compatibles pueden usar su comportamiento normal.",
